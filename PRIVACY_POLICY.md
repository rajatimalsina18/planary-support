...
- Upload your tasks, routines, challenges, notes, or progress to us
...
- Completion and incomplete status
- Everyday routine templates
...
If you choose to contact us by email, we may receive the information you choose to include in that email, such as:

- Your email address
- Your name, if included by your email account or message
- Device model, iOS version, app version, screenshots, or issue details if you choose to provide them
- Any other information you voluntarily include in the message

Support emails are used only to respond to your request, troubleshoot issues, and improve Planary.
...
You can enable, disable, or manage notifications through the App and through iOS Settings.

## Data Sharing

Planary does not share App data with third parties.

Planary does not sell user data.

Planary does not use third-party analytics, advertising, or tracking SDKs.
...
Your device may include Planary’s local app data in device backups, such as iCloud device backups or computer backups, depending on your iOS settings.

These backups are controlled by you and Apple. Planary does not control Apple’s backup systems and does not receive your backup data.

## Data Deletion

Because Planary does not maintain user accounts or server-side user records, there is no Planary account data for us to delete.

To delete Planary data from your device, you can delete the App from your device. Deleting the App removes locally stored App data from that device, subject to iOS backup and restore behavior controlled by you and Apple.
...
Planary stores data locally on your device and relies on iOS system protections to help protect that data.

No method of storage or transmission is guaranteed to be completely secure. You are responsible for maintaining the security of your device, passcode, Apple Account, and backups.

## Future Changes

Planary may add new features in the future. If Planary’s data practices change, including if optional cloud sync, accounts, analytics, or other services are introduced, this Privacy Policy will be updated before or when those changes become available.

The “Last updated” date at the top of this policy will reflect the latest revision.

## Contact

If you have questions about this Privacy Policy or Planary’s privacy practices, contact us at:
